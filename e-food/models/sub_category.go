...
// ContextValidate validates this sub category based on context it is used
func (m *SubCategory) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
